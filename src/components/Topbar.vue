...
<script>
// active-class="active" - добавляет класс active если мы находимся на той странице на которую ведет ссылка router-link  
// :to="{name: 'userProfile', params: {slug: currentUser.username}}" - можем передовать не только имя страницы а еще и параметры
